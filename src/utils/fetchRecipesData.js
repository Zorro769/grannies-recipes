...
export async function fetchRecipes(filter) {
    ...
    const url = `${process.env.REACT_APP_SERVER_URL}/spoonacular/recipes/?query=${query}&limit=100&type=${type}&diet=${diet}&maxReadyTime=${maxReadyTime}&cuisine=${cuisine}&sort=${sort.value[0]}&sortDirection=${sort.value[1]}&page=${page}&size=20&language=en&currency=${localStorage.getItem('currencyCode')}`

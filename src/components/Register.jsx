    ...
    <div className="relative h-full w-full">
        ...
        <div className='absolute text-white right-[20px] top-[20px] cursor-pointer' onClick={() => onClose()}>
            ...
            <div className='h-full w-[400px] z-20 text-center flex flex-col items-center'>
                ...
                <p className='text-[#1FB137] mt-5 text-lg font-bold'>Register with your email address and password</p>
                <form onSubmit={handleSubmit} className='text-left w-[340px] mt-10'>
                <label className='text-[#1FB137] text-lg font-bold'>
                        Username:
                        <br />
                        <input type="text" name="username" id="username" required className=' border-[#1FB137] bg-black border w-full text-lg p-2' onChange={(e) => setUsername(e.target.value)}/>
                    </label>
                    ...
                    <label className='text-[#1FB137] mt-5 text-lg font-bold block'>
                        Password:
                        <br />
                        <input type="password" name="password" required id="password" className='border-[#1FB137] bg-black border w-full text-lg p-2' onChange={(e) => setPassword(e.target.value)}/>
                    </label>
                    <label className='text-[#1FB137] mt-5 text-base font-bold block'>
                        Confirm Password:
                        <br />
                        <input type="password" name="password" required id="password" className='border-[#1FB137] bg-black border w-full text-lg p-2' onChange={(e) => setConfirmPassword(e.target.value)}/>
                    </label>

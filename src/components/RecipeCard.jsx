...
const RecipeCard = ({ recipe, flag=false, favouriteFlag = true, onClose }) => {
    ...
    return (
            ...
            <div className='bg-_gradient shadow md:w-[220px] rounded-lg relative single-item' onClick={onClose}>
          ...
          <div className='inline-block absolute right-4 top-2 '>
                ...
                flagFavourite | flag ? (
                    ...
                    <FontAwesomeIcon icon={faHeartSolid} color='#9c1616' fontSize={'30px'}/>
                    </span>
                </button> 
                ) : (
                    <button onClick={handleFavouriteClick}>
                        <span className='fa-layers text-center'>
                            <FontAwesomeIcon icon={faHeartSolid} color={"white"} fontSize={'28px'}  style={{left:1 + 'px'}}/>
                            <FontAwesomeIcon icon={faHeartBorder} color={"red"} fontSize={'30px'}  />
                        </span>
                </button> 
                )
                    ) :(
